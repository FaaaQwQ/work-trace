...
class Module:
    ...
    def stop(self) -> None:
        ...
        if not self.started:
            ...
            if self._process:
                if sys.platform == "win32" and os.environ.get("WORKTRACE_HOME"):
                    # Console entry points spawn Python children on Windows.
                    # Terminating only the entry point leaves collectors running.
                    subprocess.run(
