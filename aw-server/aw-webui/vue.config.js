...
let _COMMIT_HASH = 'source';
try {
  _COMMIT_HASH = child_process.execSync('git rev-parse --short HEAD', { stdio: ['ignore', 'pipe', 'ignore'] }).toString().trim();
} catch {
  // Source ZIP downloads do not include Git metadata.
}
...
export default {
  ...
  pwa: {
    ...
    iconPaths: {
      ...
      favicon32: 'worktrace.png',
      favicon16: 'worktrace.png',
      appleTouchIcon: 'worktrace.png',
      //maskIcon: 'worktrace.png',
      msTileImage: 'worktrace.png',
    },
    manifestOptions: {
      icons: [
        {
