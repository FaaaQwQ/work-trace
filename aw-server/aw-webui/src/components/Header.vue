  ...
  b-navbar.aw-navbar(toggleable="lg" :fixed="fixedTopMenu ? 'top' : null")
    ...
    b-navbar-nav.d-block.d-lg-none
      b-navbar-brand(to="/" style="background-color: transparent;")
        img.aligh-middle(src="/worktrace.png" style="height: 1.5em;")
        span.ml-2.align-middle(style="font-size: 1em; color: #000;") Work trace
    ...
    b-collapse#nav-collapse(is-nav)
      b-navbar-nav
        b-nav-item(to="/worktrace")
          div.px-2.px-lg-1 工作留痕
      ...
      b-navbar-nav.abs-center.d-none.d-lg-block
        b-navbar-brand(to="/" style="background-color: transparent;")
          img.ml-0.aligh-middle(src="/worktrace.png" style="height: 1.5em;")
          span.ml-2.align-middle(style="font-size: 1.0em; color: #000;") Work trace
          b-badge.ml-2.align-middle(v-if="researchEdition" variant="info" data-testid="research-edition-badge") {{ $t('app.researchEdition') }}
