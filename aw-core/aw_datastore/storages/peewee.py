...
class BucketModel(BaseModel):
    ...
    def json(self):
        # Peewee 4 decodes DateTimeField values on read; older versions may
        # return the stored ISO string. Preserve UTC for both representations.
        created = self.created if isinstance(self.created, datetime) else iso8601.parse_date(self.created)
